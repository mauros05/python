...
# You need to write a function called is_prime() that checks whether if the number passed into it is 
# a prime number or not.  It should return True or False.
...
# Today I did't do any challenge because I have english homework... so the only thing I will to is to print a Hello world
